...
Mapping a given matrix to the WSE SpMV algorithm requires (1) selecting the matrix mapping, and (2) selecting the PE grid size.
...
\begin{figure}
    ...
    \caption{Heatmap of RandSuite configurations space, showing the optimal square PE gridsize. The top right entries of the evaluation space are infeasible to run on the WSE due to PE local memory constraints.}
