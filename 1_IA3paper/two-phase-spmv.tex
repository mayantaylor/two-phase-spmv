...
\begin{enumerate}
    ...
    \item Look at performance across sparsity structures and sizes and compare to GPU (see suite sparse selections in figure \ref{fig:suite-sparse-scatter})
\end{enumerate}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/suite_sparse_scatter.png}
    \caption{Main caption}
