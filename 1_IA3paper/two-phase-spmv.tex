...
\subsection{Row-Index Materialization}
...
\begin{figure}
    \centering
    \centering
    \includegraphics[width=\linewidth]{figures/compare-precompute.pdf}
    \caption{Evaluating the performance benefit provided by row index materialization}

    \label{fig:compare-precomput}
\end{figure}
...
\textcolor{green}{TODO: basic weak and strong scaling comparison}, performance across randomly generate matrices
