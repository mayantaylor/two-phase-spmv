...
\begin{enumerate}
    ...
    \item figure out what is the max nnz we support (limited by the 48KB local memory)
    \item pick some matrices from suitesparse with different structure
    \item do analysis of theoretical load imbalance under the three layout schemes: blocked, cyclic, random
    \item look at actual performance under the three schemes
\end{enumerate}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\linewidth]{figures/suite_sparse_matrices.pdf}
    \caption{Main caption}
    \label{fig:suite-sparse-scatter}
\end{figure}
